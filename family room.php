...
<nav class="topnav">
  ...
  <h1 style="text-align:center;color:green;" >FAMILY ROOM</h1><br>
<div style="display: block;">
  <?php 
      $query1 = $conn->query("SELECT * FROM room_table WHERE room_type = 'family'");
      while($query_run1 = $query1->fetch(PDO::FETCH_ASSOC)){?>
          <table class="img" style="vertical-align:top;">
              <div style="float:left; background: rgb(180, 180, 180);s margin:0 20px; padding: 10px; box-shadow: 0 5px 5px gray; width:30%; height:400px;">
